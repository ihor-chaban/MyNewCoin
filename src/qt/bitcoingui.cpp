...
{
    resize(850+95, 550);
    setWindowTitle(tr("BCCA") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BCCA address"));
    ...
    aboutAction = new QAction(tr("&About BCCA"), this);
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BCCA network", "", count));
}
